...
public class GetMapsActivity extends FragmentActivity {
    ...
    private void setUpMap() {
        ...
        Back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent( GetMapsActivity.this, Dashboard.class);
                startActivity(intent);
                finish();

            }
        });
        idelivery=(Button)this.findViewById(R.id.idelivery);
        idelivery.setOnClickListener(new View.OnClickListener() {
        ...
        downloadTasks.execute(myapp.MyUrl+"/taskDownload?userid="+myapp.userid+"&origin="+urlEncode(getIntent().getStringExtra("origin")) + "&dest="+urlEncode(getIntent().getStringExtra("dest")));
        Log.w("",myapp.MyUrl+"/taskDownload?userid="+myapp.userid+"&origin="+urlEncode(getIntent().getStringExtra("origin")) + "&dest="+urlEncode(getIntent().getStringExtra("dest")));
...
*/
    ...
    private class DeliveryTasks extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            LinearLayout myLayout = (LinearLayout)findViewById(R.id.tasks);//linearLayout2 is used as
            ...
            try {
                ...
                for(int index = 0; index<jObject.getJSONArray("tasks").length(); index++) {
                    ...
                    + "\nTime Overhead:  "+ Task.getInt("duration")/60 + "mins"
